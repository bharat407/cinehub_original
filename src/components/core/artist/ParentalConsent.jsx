      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto relative">
        ...
        <div className="p-8">
          ...
          <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            legally appointed guardian of the minor child named above, and that
            I have every right to contract for the minor child in the above
            regard.
          </p>

          <p className="mb-6 text-gray-700 leading-relaxed">
            I certify and acknowledge that I have read, understood and agree to
            the{" "}
            ...
            talentrack and that I consent to provide the information concerning
            my minor child that is necessary to create a portfolio and to apply
            for jobs/auditions on the platform.
          </p>
